/**
 * data/foods.ts — Base de données locale des aliments
 * 
 * Contient une liste d'aliments courants avec leurs valeurs nutritionnelles pour 100g.
 * Ces données sont utilisées dans le scanner pour la recherche manuelle d'aliments.
 * 
 * Chaque aliment inclut :
 * - Macronutriments (calories, glucides, protéines, lipides, fibres)
 * - Index glycémique (crucial pour la gestion du diabète)
 * - Taille de portion suggérée
 * 
 * Pour les produits industriels, le scanner code-barres utilise l'API Open Food Facts.
 * Pour les plats cuisinés, le scanner photo utilise l'IA pour estimer les valeurs.
 */
...
/**
 * Recherche un aliment par nom ou catégorie.
 * Si la requête est vide, retourne tous les aliments.
 */
...
/** Retrouve un aliment par son identifiant unique */
